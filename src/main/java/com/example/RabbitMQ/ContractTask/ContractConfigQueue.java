...
public class ContractConfigQueue {
    ...
    @Bean
    public RabbitTemplate rabbitTemplateCont(ConnectionFactory connectionFactory) {
    ...
    @Bean
    public SimpleRabbitListenerContainerFactory rabbitListenerContainerFactoryContract(
