...
public class UpdateFilmConfigQueue {
    ...
    @Bean
    public RabbitTemplate rabbitTemplateUpdateC(ConnectionFactory connectionFactory) {
    ...
    @Bean
    public SimpleRabbitListenerContainerFactory rabbitListenerContainerFactoryUpdate(
